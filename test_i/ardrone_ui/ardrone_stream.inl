...
#else
                        SessionMessageType>::onSignalQualityChange (const std::string& interfaceIdentifier_in,
...
#else
                        SessionMessageType>::onAssociate (const std::string& interfaceIdentifier_in,
#endif // ACE_WIN32 || ACE_WIN64
...
#else
                        SessionMessageType>::onDisassociate (const std::string& interfaceIdentifier_in,
#endif // ACE_WIN32 || ACE_WIN64
                                                             const std::string& SSID_in,
                                                             bool success_in)
{
...
#else
                        SessionMessageType>::onConnect (const std::string& interfaceIdentifier_in,
#endif // ACE_WIN32 || ACE_WIN64
                                                        const std::string& SSID_in,
                                                        bool success_in)
{
...
#else
                        SessionMessageType>::onDisconnect (const std::string& interfaceIdentifier_in,
#endif // ACE_WIN32 || ACE_WIN64
                                                           const std::string& SSID_in,
                                                           bool success_in)
{
...
#else
                        SessionMessageType>::onHotPlug (const std::string& interfaceIdentifier_in,
#endif // ACE_WIN32 || ACE_WIN64
                                                        bool enabled_in)
{
...
#else
                        SessionMessageType>::onRemove (const std::string& interfaceIdentifier_in,
#endif // ACE_WIN32 || ACE_WIN64
                                                       bool enabled_in)
{
...
#else
                        SessionMessageType>::onScanComplete (const std::string& interfaceIdentifier_in)
#endif // ACE_WIN32 || ACE_WIN64
{
