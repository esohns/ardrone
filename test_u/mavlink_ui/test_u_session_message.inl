                        ...
                        SessionDataType>::duplicate (void) const
{
  ...
  // create a new <Test_U_SessionMessage_T> that contains unique copies of
  ...
  // *WARNING*: the allocator returns a Stream_CamSave_SessionMessage_Base_T<ConfigurationType>
