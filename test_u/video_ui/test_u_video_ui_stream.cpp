...
bool
Test_U_DirectShow_Stream::load (Stream_ModuleList_t& modules_out,
                                        bool& delete_out)
{
...
Test_U_DirectShow_Stream::initialize (const inherited::CONFIGURATION_T& configuration_in)
{
  ...
  Test_U_DirectShow_SessionData* session_data_p = NULL;
  inherited::CONFIGURATION_T::ITERATOR_T iterator, iterator_2;
...
continue_:
  ...
  session_data_p =
    &const_cast<Test_U_DirectShow_SessionData&> (inherited::sessionData_->getR ());
...
bool
Test_U_MediaFoundation_Stream::load (Stream_ModuleList_t& modules_out,
                                             bool& delete_out)
{
...
Test_U_MediaFoundation_Stream::initialize (const inherited::CONFIGURATION_T& configuration_in)
{
  ...
  bool setup_pipeline = configuration_in.configuration_.setupPipeline;
  bool reset_setup_pipeline = false;
  Test_U_MediaFoundation_SessionData* session_data_p = NULL;
  inherited::CONFIGURATION_T::ITERATOR_T iterator;
  struct Test_U_MediaFoundation_ModuleHandlerConfiguration* configuration_p =
    NULL;
  ...
  session_data_p =
    &const_cast<Test_U_MediaFoundation_SessionData&> (inherited::sessionData_->getR ());
  iterator =
      const_cast<inherited::CONFIGURATION_T&> (configuration_in).find (ACE_TEXT_ALWAYS_CHAR (""));
  ...
  configuration_p =
      dynamic_cast<struct Test_U_MediaFoundation_ModuleHandlerConfiguration*> (&(*iterator).second.second);
...
bool
Test_U_Stream::load (typename inherited::LAYOUT_T& layout_inout,
                                  bool& delete_out)
{
