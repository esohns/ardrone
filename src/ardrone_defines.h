...
#define ARDRONE_STREAM_MDOULE_CONTROL_DECODER_NAME_STRING   "ControlDecoder"
//#define ARDRONE_STREAM_MDOULE_HANDLER_NAME_STRING           "EventHandler"
#define ARDRONE_STREAM_MDOULE_MAVLINK_DECODER_NAME_STRING   "MAVLinkDecoder"
#define ARDRONE_STREAM_MDOULE_NAVDATA_DECODER_NAME_STRING   "NavDataDecoder"
