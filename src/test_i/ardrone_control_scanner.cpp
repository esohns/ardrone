...
YY_BUFFER_STATE ARDrone_Control_Scanner__scan_string (yyconst char *yy_str ,yyscan_t yyscanner );
YY_BUFFER_STATE ARDrone_Control_Scanner__scan_bytes (yyconst char *bytes,int len ,yyscan_t yyscanner );
...
static yyconst flex_int32_t yy_accept[21] =
    {   0,
        0,    0,    3,    3,    0,    0,    5,    5,    0,    0,
        9,    2,    1,    7,    3,    4,    5,    6,    3,    5
    } ;
...
static yyconst yy_state_type yy_NUL_trans[21] =
    {   0,
       12,   12,   15,   15,   14,   14,   17,   17,   14,   14,
        0,    0,    0,    0,   19,    0,   20,    0,   19,   20
    } ;

static yyconst flex_int32_t yy_rule_linenum[8] =
    {   0,
       73,   74,   78,   82,   85,   90,   94
    } ;
...
/* %% [7.0] user's declarations go here */
  ...
  ARDrone_Control_IParser_t* iparser_p =
      const_cast<ARDrone_Control_IParser_t*> (iscanner_in->getP ());
...
YY_RULE_SETUP
{ current_key_string = Common_Tools::strip (yytext);
                  BEGIN (delimiter); }
	YY_BREAK
// end <key>
...
case 5:
YY_RULE_SETUP
{ ACE_ASSERT (!current_key_string.empty ());
                  configuration_r.insert (std::make_pair (current_key_string, Common_Tools::strip (yytext)));
                  BEGIN (newline); }
	YY_BREAK
// end <value>
...
/* %endif */
{
		...
		while ( num_to_read <= 0 )
			...
			if ( b->yy_is_our_buffer )
				...
				b->yy_ch_buf = (char *)
					...
					ARDrone_Control_Scanner_realloc((void *) b->yy_ch_buf,b->yy_buf_size + 2 ,yyscanner );
				}
			else
	...
	if ((int) (yyg->yy_n_chars + number_to_move) > YY_CURRENT_BUFFER_LVALUE->yy_buf_size) {
		...
		YY_CURRENT_BUFFER_LVALUE->yy_ch_buf = (char *) ARDrone_Control_Scanner_realloc((void *) YY_CURRENT_BUFFER_LVALUE->yy_ch_buf,new_size ,yyscanner );
...
/* %endif */
{
	 ...
	 */
	b->yy_ch_buf = (char *) ARDrone_Control_Scanner_alloc(b->yy_buf_size + 2 ,yyscanner );
	if ( ! b->yy_ch_buf )
		YY_FATAL_ERROR( "out of dynamic memory in ARDrone_Control_Scanner__create_buffer()" );
 ...
 */
YY_BUFFER_STATE ARDrone_Control_Scanner__scan_string (yyconst char * yystr , yyscan_t yyscanner)
{
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE ARDrone_Control_Scanner__scan_bytes  (yyconst char * yybytes, int  _yybytes_len , yyscan_t yyscanner)
{
	YY_BUFFER_STATE b;
	char *buf;
	yy_size_t n;
